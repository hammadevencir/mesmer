...
const EditBreathingExerciseDialog = ({ children, exercise, onUpdate }) => {
  ...
  useEffect(() => {
    if (open && exercise) {
      setForm({
        ...
        cycleCount:
          exercise.cycleCount !== undefined && exercise.cycleCount !== null
            ? String(exercise.cycleCount)
            : "",
        breathInDuration:
          exercise.breathInDuration !== undefined &&
          exercise.breathInDuration !== null
            ? String(exercise.breathInDuration)
            : "",
        breathOutDuration:
          exercise.breathOutDuration !== undefined &&
          exercise.breathOutDuration !== null
            ? String(exercise.breathOutDuration)
            : "",
        sheetTitle: exercise.sheetTitle ?? "",
      });
    }
  }, [open, exercise]);
...
export default EditBreathingExerciseDialog;
