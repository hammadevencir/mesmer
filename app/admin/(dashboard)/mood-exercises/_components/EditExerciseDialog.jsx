...
const EditExerciseDialog = ({
  ...
  const onboardingSwitchDisabled =
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      >
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-row items-start justify-between gap-4 mt-2 p-4 rounded-[16px] border border-[#E9D5FF] bg-[#FDFAFF]">
              <div className="min-w-0 pr-2">
                ...
                >
                  {otherOnboardingCount} of {maxOnboardingExercises} onboarding
                  slots are used by other exercises. Maximum{" "}
                  {maxOnboardingExercises} total.
                </p>
              </div>
              <Switch
                checked={formData.isOnBoarding === true}
                onCheckedChange={(v) => handleChange("isOnBoarding", v)}
                disabled={onboardingSwitchDisabled}
        ...
        <div className="p-4 sm:p-6 border-t border-[#F3F4F6] shrink-0 flex gap-3 sm:gap-4 bg-white">
          ...
          <Button
            variant="outline"
            className="hidden sm:inline-flex w-[150px] h-[44px] sm:h-[52px] rounded-full border-[#d1d5db] text-[#4b5563] hover:bg-gray-50 hover:text-gray-900 text-[14px] sm:text-[16px] font-bold"
